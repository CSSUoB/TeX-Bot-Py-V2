...
* `E1022` - The CSS Discord server does not contain a role with the name "Guest" (required for the `/induct`, `/stats` & `/archive` commands and the `kick_no_introduction_members` & `introduction_reminder` tasks)
