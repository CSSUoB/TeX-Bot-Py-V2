...
class LogLevels(str, Enum, metaclass=MetaEnum):  # noqa: UP042
...
DEFAULT_DISCORD_API_LOGGING_ENABLED: "Final[bool]" = False
DEFAULT_DISCORD_API_LOGGING_LOG_LEVEL: "Final[LogLevels]" = LogLevels.INFO
DEFAULT_DISCORD_API_LOGGING_FILE_NAME: "Final[str]" = "discord.log"
...
DEFAULT_STRIKE_REPORTED_MESSAGE_DESTINATION_CHANNEL: "Final[str]" = "discord"
...
DEFAULT_SEND_INTRODUCTION_REMINDERS_ENABLED: "Final[SendIntroductionRemindersFlagType]" = (
    "once"
)
...
DEFAULT_MSL_AUTO_COOKIE_CHECKING_ENABLED: "Final[bool]" = False
DEFAULT_MSL_AUTO_COOKIE_CHECKING_INTERVAL: "Final[str]" = "10m"

DEFAULT_AUTO_ADD_COMMITTEE_TO_THREADS: "Final[bool]" = True
